...
label1 = Label(text="Timer", font=(FONT_NAME, 20, "bold"), fg=GREEN, highlightthickness=0, bg=YELLOW)
label1.grid(column=1, row=0)

label2 = Label(font=(FONT_NAME, 10, "bold"), fg=GREEN, highlightthickness=0, bg=YELLOW)
